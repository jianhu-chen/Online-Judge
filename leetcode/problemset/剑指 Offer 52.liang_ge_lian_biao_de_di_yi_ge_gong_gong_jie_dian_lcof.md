...
[打开力扣](https://leetcode.cn/problems/liang-ge-lian-biao-de-di-yi-ge-gong-gong-jie-dian-lcof) [我的代码](剑指 Offer 52.liang_ge_lian_biao_de_di_yi_ge_gong_gong_jie_dian_lcof.py)

输入两个链表，找出它们的第一个公共节点。

如下面的两个链表<strong>：</strong>
